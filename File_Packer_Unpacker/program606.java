...
class program606
{
    public static void main(String A[]) throws Exception
    {
        ...
        if((fobj.exists()) && (fobj.isDirectory()))
        {
            ...
            File fArr[] = fobj.listFiles();  // array of File class

            System.out.println("No of files in the folder are : "+fArr.length);

            for(i = 0; i < fArr.length; i++)   // Travels no of file times
            {
